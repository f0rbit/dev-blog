...
export const posts = sqliteTable('posts', {
  ...
  unique('posts_author_slug_unique').on(table.author_id, table.slug),
])
...
export const categories = sqliteTable('categories', {
  ...
  unique('categories_owner_name_unique').on(table.owner_id, table.name),
])
...
export const tags = sqliteTable('tags', {
  ...
  primaryKey({ columns: [table.post_id, table.tag] }),
])
...
export const fetchLinks = sqliteTable('fetch_links', {
  ...
  unique('fetch_links_integration_identifier_unique').on(table.integration_id, table.identifier),
])
