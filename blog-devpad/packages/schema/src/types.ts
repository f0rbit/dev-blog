...
export const isPublished = (post: PublishAtField): boolean =>
  post.publish_at !== null && post.publish_at <= new Date()

export const isScheduled = (post: PublishAtField): boolean =>
  post.publish_at !== null && post.publish_at > new Date()

export const isDraft = (post: PublishAtField): boolean =>
