        ...
        >
          <For each={statusOptions}>
            {(option) => (
              <button
                type="button"
                class="post-status__option"
                style={optionStyles(option.value === props.value)}
...
const StatusIcon: Component<{ path: string; status: PostStatus }> = (props) => (
  <svg
    ...
    style={{ color: `var(--status-${props.status})` }}
  >
    <path d={props.path} />
  </svg>
);
...
const CheckIcon: Component = () => (
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    style={{ color: "var(--input-focus)", "margin-left": "auto" }}
  >
